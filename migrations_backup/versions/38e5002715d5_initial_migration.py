...
Revision ID: 38e5002715d5
Revises: 
Create Date: 2023-09-13 16:58:14.927616
...
def upgrade():
    ...
    op.create_table('daily_nutrient',
    sa.Column('id', sa.Integer(), nullable=False),
    ...
    with op.batch_alter_table('daily_nutrient', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_daily_nutrient_date'), ['date'], unique=False)
